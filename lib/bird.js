...
class Bird extends EventEmitter {
  constructor(x, y, width, height, ctx) {
    ...
    this.image.src = '../assets/images/flappy-bird-up-sprite.png';
    this.gravity = 0;
    this.frameCount = 0
    this.frame = 0;
  };
  ...
  get move () {
    ...
    if (this.gravity > 250) {
      this.image.src = '../assets/images/flappy-bird-down-sprite.png';
    }
  ...
  animateBirdFrames () {
    if (this.frameCount > 0 && this.frameCount < 20) {
      this.ctx.drawImage(this.image, 0, 0, 57, 60, this.x, this.y, 57, 60)
    } else if (this.frameCount > 20 && this.frameCount < 40) {
